    ...
    9247: function (e, t) {
      ...
      t.createElement = function (e, t, o) {
        var n,
          ...
          f = null,
          c = null;
        if (null != t) for (n in (void 0 !== t.ref && (c = t.ref), void 0 !== t.key && (f = '' + t.key), t)) i.call(t, n) && !l.hasOwnProperty(n) && (a[n] = t[n]);
        ...
        if (e && e.defaultProps) for (n in (p = e.defaultProps)) void 0 === a[n] && (a[n] = p[n]);
        return { $$typeof: r, type: e, key: f, ref: c, props: a, _owner: s.current };
      };
    },
    8012: function (e, t, r) {
      e.exports = r(9247);
