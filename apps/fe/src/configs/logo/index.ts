...
import CLangIcon from '@/assets/images/c-icon.svg';
...
import EChartsIcon from '@/assets/images/echarts-icon.svg';
import ExpoIcon from '@/assets/images/expo-icon.svg';
...
import GithubActionsIcon from '@/assets/images/github-actions-icon.svg';
import GrailsIcon from '@/assets/images/grails-icon.svg';
import HibernateIcon from '@/assets/images/hibernate-icon.svg';
...
import KubernetesIcon from '@/assets/images/k8s-icon.svg';
import MariaDbIcon from '@/assets/images/mariadb-icon.svg';
...
import PnpmIcon from '@/assets/images/pnpm-icon.svg';
import PostgreSqlIcon from '@/assets/images/psql-icon.svg';
import PythonIcon from '@/assets/images/python-icon.svg';
import ReactIcon from '@/assets/images/react-icon.svg';
import ReactQueryIcon from '@/assets/images/react-query-icon.svg';
import RecoilIcon from '@/assets/images/recoil-icon.svg';
...
import SwrIcon from '@/assets/images/swr-icon.svg';
import ApacheTomcatIcon from '@/assets/images/tomcat-icon.svg';
import TypeOrmIcon from '@/assets/images/typeorm-icon.svg';
