    ...
    1783: function (e, t, n) {
      ...
      var ev = function (e) {
        return ee.createElement(
          'svg',
          eg({ xmlns: 'http://www.w3.org/2000/svg', width: 10, height: 10, fill: 'none' }, e),
          x ||
            (x = ee.createElement(
              'g',
          ...
          j || (j = ee.createElement('defs', null, ee.createElement('clipPath', { id: 'react-icon_svg__a' }, ee.createElement('path', { fill: '#fff', d: 'M0 0h10v10H0z' }))))
        );
      };
      function ed() {
      ...
      ((a = R || (R = {})).AntDesign = 'AntDesign'),
        (a.ApacheTomcat = 'ApacheTomcat'),
        (a.ApolloClient = 'ApolloClient'),
        (a.Docker = 'Docker'),
        (a.Java = 'Java'),
        (a.MaterialUi = 'MaterialUI'),
        (a.MongoDb = 'MongoDB'),
        (a.MySql = 'MySQL'),
        (a.NextJs = 'NextJS'),
        (a.Nginx = 'Nginx'),
        ...
        (a.Python = 'Python'),
        (a.React = 'React'),
        (a.ReactNative = 'ReactNative'),
        (a.Redux = 'Redux'),
        (a.Sass = 'Sass'),
        (a.Spring = 'Spring'),
        (a.SpringBoot = 'SpringBoot'),
      ...
      let eM = [
        ...
        eO = {
          [R.React]: { href: 'https://ko.reactjs.org/', label: 'React', icon: ev, svgProps: { width: 14, height: 14, viewBox: '0 0 10 10' }, backgroundColor: '#2EBBEF' },
          [R.ReactNative]: { href: 'https://reactnative.dev/', label: 'React Native', icon: ev, svgProps: { width: 14, height: 14, viewBox: '0 0 10 10' }, backgroundColor: '#1694C2' },
          [R.Sass]: {
            ...
            icon: function (e) {
              return ee.createElement(
                'svg',
                eu({ xmlns: 'http://www.w3.org/2000/svg', width: 10, height: 10, fill: 'none' }, e),
                O ||
                  (O = ee.createElement(
                    'g',
                ...
                k || (k = ee.createElement('defs', null, ee.createElement('clipPath', { id: 'sass-icon_svg__a' }, ee.createElement('path', { fill: '#fff', d: 'M0 0h10v10H0z' }))))
              );
            },
            svgProps: { width: 14, height: 14, viewBox: '0 0 10 10' },
          ...
          [R.Vue]: {
            ...
            icon: function (e) {
              return ee.createElement(
                'svg',
                ey({ xmlns: 'http://www.w3.org/2000/svg', width: 11, height: 9, fill: 'none' }, e),
                B || (B = ee.createElement('path', { fill: '#fff', d: 'M8.763 0H6.875L5.5 2.078 4.321 0H0l5.5 9L11 0H8.763ZM1.368.75h1.32L5.5 5.4 8.309.75h1.32L5.5 7.51 1.368.75Z' }))
              );
            },
            svgProps: { width: 16, height: 12, viewBox: '0.5 -0.7 10 10' },
          ...
          [R.Java]: {
            ...
            icon: function (e) {
              return ee.createElement(
                'svg',
                er({ xmlns: 'http://www.w3.org/2000/svg', width: 8, height: 10, fill: 'none' }, e),
                i ||
          ...
          [R.Python]: {
            ...
            icon: function (e) {
              return ee.createElement(
                'svg',
                ef({ xmlns: 'http://www.w3.org/2000/svg', width: 10, height: 10, fill: 'none' }, e),
                Z ||
          ...
          [R.Docker]: {
            ...
            icon: function (e) {
              return ee.createElement(
                'svg',
                ea({ xmlns: 'http://www.w3.org/2000/svg', width: 12, height: 9, fill: 'none' }, e),
                o ||
            ...
            svgProps: { width: 21, height: 16, viewBox: '0.5 -1.5 12 12' },
          ...
          [R.MySql]: {
            ...
            icon: function (e) {
              return ee.createElement(
                'svg',
                eo({ xmlns: 'http://www.w3.org/2000/svg', width: 10, height: 10, fill: 'none' }, e),
                p ||
                  (p = ee.createElement(
                    'g',
                ...
                f || (f = ee.createElement('defs', null, ee.createElement('clipPath', { id: 'mysql-icon_svg__a' }, ee.createElement('path', { fill: '#fff', d: 'M0 0h10v10H0z' }))))
              );
            },
            svgProps: { width: 14, height: 14, viewBox: '0 0 10 10' },
          ...
          [R.Spring]: {
            ...
            icon: function (e) {
              return ee.createElement(
                'svg',
                ew({ xmlns: 'http://www.w3.org/2000/svg', width: 10, height: 10, fill: 'none' }, e),
                P ||
          ...
          [R.SpringBoot]: {
            ...
            icon: function (e) {
              return ee.createElement(
                'svg',
                em({ xmlns: 'http://www.w3.org/2000/svg', width: 10, height: 10, fill: 'none' }, e),
                C ||
                  (C = ee.createElement(
                    'g',
                ...
                V || (V = ee.createElement('defs', null, ee.createElement('clipPath', { id: 'springboot-icon_svg__a' }, ee.createElement('path', { fill: '#fff', d: 'M0 0h10v10H0z' }))))
              );
            },
            svgProps: { width: 14, height: 14, viewBox: '0 0 10 10' },
          ...
          [R.NextJs]: {
            ...
            icon: function (e) {
              return ee.createElement(
                'svg',
                ei({ xmlns: 'http://www.w3.org/2000/svg', fill: 'none', viewBox: '0 0 394 80' }, e),
                g ||
          ...
          [R.ApolloClient]: {
            ...
            icon: function (e) {
              return ee.createElement(
                'svg',
                en({ xmlns: 'http://www.w3.org/2000/svg', width: 10, height: 10, fill: 'none' }, e),
                l ||
                  (l = ee.createElement(
                    'g',
                    { fill: '#fff', clipPath: 'url(#apollo-icon_svg__a)' },
                    ee.createElement('path', {
                ...
                c || (c = ee.createElement('defs', null, ee.createElement('clipPath', { id: 'apollo-icon_svg__a' }, ee.createElement('path', { fill: '#fff', d: 'M0 0h10v10H0z' }))))
              );
            },
            svgProps: { width: 14, height: 14, viewBox: '0 0 10 10' },
          ...
          [R.PostgreSql]: {
            ...
            icon: function (e) {
              return ee.createElement(
                'svg',
                ep({ xmlns: 'http://www.w3.org/2000/svg', width: 10, height: 10, fill: 'none' }, e),
                m ||
                  (m = ee.createElement(
                    'g',
                    ...
                    ee.createElement('path', {
                      ...
                      strokeLinejoin: 'round',
                      strokeWidth: 0.2,
                      d: 'M8.032 2.771c.02.36-.077.604-.09.986-.018.556.265 1.192-.161 1.829',
                    })
                  )),
                b || (b = ee.createElement('defs', null, ee.createElement('clipPath', { id: 'psql-icon_svg__a' }, ee.createElement('path', { fill: '#fff', d: 'M0 0h10v10H0z' }))))
              );
            },
            svgProps: { width: 14, height: 14, viewBox: '0 0 10 10' },
          ...
          [R.Oracle]: {
            ...
            icon: function (e) {
              return ee.createElement(
                'svg',
                es({ xmlns: 'http://www.w3.org/2000/svg', width: 15, height: 2, fill: 'none' }, e),
                u ||
                  (u = ee.createElement(
                    'g',
                ...
                w || (w = ee.createElement('defs', null, ee.createElement('clipPath', { id: 'oracle-icon_svg__a' }, ee.createElement('path', { fill: '#fff', d: 'M0 0h15v2H0z' }))))
              );
            },
            svgProps: { width: 34, height: 20, viewBox: '2.5 -4 10 10' },
          ...
          [R.MongoDb]: {
            ...
            icon: function (e) {
              return ee.createElement(
                'svg',
                el({ xmlns: 'http://www.w3.org/2000/svg', width: 4, height: 10, fill: 'none' }, e),
                h ||
            ...
            svgProps: { width: 14, height: 14, viewBox: '-2 0 10 10' },
          ...
          [R.Yarn]: {
            ...
            icon: function (e) {
              return ee.createElement(
                'svg',
                eE({ xmlns: 'http://www.w3.org/2000/svg', width: 10, height: 10, fill: 'none' }, e),
                D ||
            ...
            svgProps: { width: 14, height: 14, viewBox: '0 -0.5 10 10' },
          ...
          [R.Vite]: {
            ...
            icon: function (e) {
              return ee.createElement(
                'svg',
                ej({ xmlns: 'http://www.w3.org/2000/svg', width: 10, height: 10, fill: '#fff' }, e),
                A ||
            ...
            svgProps: { width: 14, height: 14, viewBox: '0 0 10 10', fill: $.Z[700] },
          ...
          [R.AntDesign]: {
            ...
            icon: function (e) {
              return ee.createElement(
                'svg',
                et({ xmlns: 'http://www.w3.org/2000/svg', width: 10, height: 10, fill: 'none' }, e),
                r ||
          ...
          [R.Storybook]: {
            ...
            icon: function (e) {
              return ee.createElement(
                'svg',
                eb({ xmlns: 'http://www.w3.org/2000/svg', width: 7, height: 8, fill: 'none' }, e),
                H ||
                  (H = ee.createElement('path', {
                    fill: '#fff',
                    fillRule: 'evenodd',
            ...
            svgProps: { width: 14, height: 14, viewBox: '-1 -1 10 10' },
          ...
          [R.MaterialUi]: {
            ...
            icon: function (e) {
              return ee.createElement(
                'svg',
                ec({ xmlns: 'http://www.w3.org/2000/svg', width: 9, height: 8, fill: 'none' }, e),
                s ||
          ...
          [R.Redux]: {
            ...
            icon: function (e) {
              return ee.createElement(
                'svg',
                ed({ xmlns: 'http://www.w3.org/2000/svg', width: 11, height: 10, fill: 'none' }, e),
                y ||
            ...
            svgProps: { width: 14, height: 14, viewBox: '0 0 12 10' },
          ...
          [R.TypeScript]: {
            ...
            icon: function (e) {
              return ee.createElement(
                'svg',
                ex({ xmlns: 'http://www.w3.org/2000/svg', width: 8, height: 8, fill: 'none' }, e),
                _ ||
            ...
            svgProps: { width: 14, height: 14, viewBox: '0 0 8 8' },
          ...
          [R.Nginx]: {
            ...
            icon: function (e) {
              return ee.createElement(
                'svg',
                eh({ xmlns: 'http://www.w3.org/2000/svg', width: 9, height: 11, fill: 'none' }, e),
                d ||
                  (d = ee.createElement('path', {
                    fill: '#fff',
                    fillRule: 'evenodd',
          ...
          [R.ApacheTomcat]: {
            ...
            icon: function (e) {
              return ee.createElement(
                'svg',
                eZ({ xmlns: 'http://www.w3.org/2000/svg', width: 11, height: 8, fill: 'none' }, e),
                L ||
                  (L = ee.createElement(
                    'g',
                    { fill: '#67592E', clipPath: 'url(#tomcat-icon_svg__a)' },
                    ee.createElement('path', {
                ...
                S || (S = ee.createElement('defs', null, ee.createElement('clipPath', { id: 'tomcat-icon_svg__a' }, ee.createElement('path', { fill: '#fff', d: 'M0 0h11v8H0z' }))))
              );
            },
            svgProps: { width: 18, height: 14, viewBox: '0 -1.5 11 11' },
      ...
      function eP() {
        let [e, t] = (0, F.useState)(!1),
          n = (0, ek.q)((e) => e.setDarkMode);
        return (0, N.jsxs)(N.Fragment, {
          children: [
            (0, N.jsxs)(T.ZP, { display: 'flex', justifyContent: 'space-between', alignItems: 'center', children: [(0, N.jsx)(I.Z, { height: 48 }), (0, N.jsx)(eV, { onChange: () => n() })] }),
            (0, N.jsx)(J.ZP, {
              anchor: 'left',
              open: e,
              onClose: () => t(!1),
              children: (0, N.jsx)(U.Z, {
                style: { width: 200 },
                children: eM.map((e, t) => {
                  let { label: n, path: a } = e;
                  return (0, N.jsx)(Y.ZP, { children: (0, N.jsx)(eC, { href: a, children: (0, N.jsx)(Q.Z, { children: (0, N.jsx)(X.Z, { children: n }) }) }) }, t);
                }),
              }),
            }),
          ],
      ...
      let eC = (0, G.ZP)(q())({ textDecoration: 'none', width: '100%', color: 'unset' }),
        eV = (0, G.ZP)(K.Z)((e) => {
          let { theme: t } = e;
          return {
            width: 48,
      ...
      var eH = n(1487),
        eL = n(5091);
      let eS = (0, G.ZP)(eH.Z)({ display: 'flex', textDecoration: 'none' }),
        e_ = (0, G.ZP)(eL.Z)((e) => {
          let { theme: t, ...n } = e;
          return {
            backgroundColor: n['background-color'],
            borderRadius: 3,
            color: null !== (z = n['text-color']) && void 0 !== z ? z : t.palette.common.white,
            fontSize: 12,
            fontWeight: 400,
            height: 22,
            cursor: 'pointer',
      ...
      function eA(e) {
        let { href: t, label: n, icon: a, svgProps: r, backgroundColor: l, textColor: c } = e;
        return (0, N.jsx)(eS, { href: t, target: '_blank', children: (0, N.jsx)(e_, { icon: (0, N.jsx)(a, { ...r }), label: n, 'background-color': l, 'text-color': c }) });
      }
      let eB = Object.entries(eO).reduce((e, t) => {
        let [n, a] = t;
        return { ...e, [n]: () => (0, N.jsx)(eA, { ...a }) };
      }, {});
      var eD = n(5953),
        eR = n.n(eD),
        ez = n(1834),
      ...
      function e3(e) {
        ...
        let { data: n } = e,
          a = (0, eQ.Z)(),
          r = (0, eX.Z)(a.breakpoints.down('md')),
          l = (0, eX.Z)(a.breakpoints.down('sm')),
          c = (0, F.useCallback)((e, t) => {
            let n =
              e2()(null != t ? t : void 0)
                .endOf('month')
                .diff(e, 'month') + 1;
            return n >= 12 ? (n % 12 == 0 ? ''.concat(n / 12, '년') : ''.concat(Math.floor(n / 12), '년 ').concat(n % 12, '개월')) : ''.concat(n, '개월');
          }, []);
        return (0, N.jsxs)(e4, {
          variant: 'outlined',
          children: [
            (0, N.jsxs)(T.ZP, {
              ...
              children: [
                (0, N.jsxs)(T.ZP, {
                  ...
                  gap: 3,
                  children: [
                    n.logo && (0, N.jsx)(eR(), { ...n.logo, width: (n.logo.width * (l ? 30 : 50)) / n.logo.height, height: l ? 30 : 50 }),
                    (0, N.jsxs)(T.ZP, {
                      display: 'flex',
                      ...
                      gap: l ? 0 : 1,
                      children: [
                        (0, N.jsx)(eG.Z, { fontWeight: 700, fontSize: l ? 18 : 24, letterSpacing: -1, children: n.companyName }),
                        (0, N.jsx)(eG.Z, {
                          fontWeight: 700,
                          fontSize: l ? 14 : 20,
                          letterSpacing: -1,
                          color: 'dark' === a.palette.mode ? e0.Z[400] : e0.Z[700],
                          children: '('
                            .concat(n.startDate, ' ~ ')
                            .concat(null !== (t = n.endDate) && void 0 !== t ? t : '재직 중', ', ')
                            .concat(c(n.startDate, n.endDate), ')'),
                        }),
                      ],
                    }),
                  ],
                }),
                n.website && (0, N.jsx)(eK.Z, { href: n.website, target: '_blank', children: (0, N.jsx)(e5, {}) }),
              ],
            }),
            n.description && (0, N.jsx)(T.ZP, { paddingY: l ? 3 : 5, children: (0, N.jsx)(eG.Z, { fontWeight: 400, fontSize: l ? 13 : 18, letterSpacing: -1, children: n.description }) }),
            n.careers.map((e, t) =>
              (0, N.jsxs)(
                F.Fragment,
                {
                  children: [
                    (0, N.jsx)(eG.Z, { fontWeight: 700, fontSize: l ? 18 : 22, letterSpacing: -1, children: e.groupName }),
                    (0, N.jsx)(e6, {
                      sx: { ['& .'.concat(eF.Z.root, ':before')]: { flex: 0, padding: 0 } },
                              ...
                              !l &&
                                (0, N.jsx)(e9, {
                                  ...
                                  children: ''
                                    .concat(t.startDate, '\n~ ')
                                    .concat(t.endDate, '\n(')
                                    .concat(e2()(t.endDate).diff(e2()(t.startDate), 'month'), '개월)'),
                                }),
                              (0, N.jsxs)(eq.Z, {
                                children: [
                                  t.completed ? (0, N.jsx)(e7, { variant: 'outlined', color: 'primary' }) : (0, N.jsx)(e8, { variant: 'outlined', children: (0, N.jsx)(ez.Z, {}) }),
                                  n < e.list.length - 1 && (0, N.jsx)(eT.Z, {}),
                                ],
                              }),
                              (0, N.jsxs)(tt, {
                                whiteSpace: 'pre-line',
                                children: [
                                  (0, N.jsx)(eG.Z, { fontWeight: 700, fontSize: l ? 16 : 20, letterSpacing: -1, children: t.name }),
                                  l &&
                                    (0, N.jsx)(te, {
                                      children: ''
                                        .concat(t.startDate, ' ~ ')
                                  ...
                                  t.description && (0, N.jsx)(eG.Z, { fontWeight: 400, fontSize: l ? 13 : 18, letterSpacing: -0.5, children: t.description }),
                                ],
                              }),
                            ],
                          },
      ...
      let e4 = (0, G.ZP)(e$.Z)((e) => {
          ...
          return {
            width: '100%',
            maxWidth: 1e3,
            borderColor: 'dark' === t.palette.mode ? e0.Z[700] : e0.Z[400],
            borderRadius: 10,
            padding: 32,
        ...
        e5 = (0, G.ZP)(eN.Z)((e) => {
          let { theme: t } = e;
          return { fill: 'dark' === t.palette.mode ? e0.Z[400] : e0.Z[900] };
        }),
        e6 = (0, G.ZP)(eI.Z)({ display: 'flex', justifyContent: 'flex-start', paddingLeft: 0, paddingRight: 0 }),
        e7 = (0, G.ZP)(eJ.Z)({ width: 14, height: 14, margin: '2px 6px' }),
        e8 = (0, G.ZP)(e7)({ width: 24, height: 24, border: 'none', margin: '0 1px', padding: 0 }),
        e9 = (0, G.ZP)(eU.Z)((e) => {
          let { theme: t } = e;
          return {
            fontSize: 14,
            color: 'dark' === t.palette.mode ? e0.Z[300] : e0.Z[700],
            flex: 0.1,
            minWidth: 75,
            paddingTop: 0,
            paddingLeft: 0,
        ...
        te = (0, G.ZP)(eG.Z)((e) => {
          let { theme: t } = e;
          return { color: 'dark' === t.palette.mode ? e0.Z[300] : e0.Z[700], fontSize: 12, margin: '2px 0 14px' };
        }),
        tt = (0, G.ZP)(eY.Z)({ paddingTop: 0, paddingBottom: 40 });
    },
    3595: function (e, t, n) {
      n.d(t, {
        q: function () {
