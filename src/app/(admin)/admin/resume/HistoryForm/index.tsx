      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <FormItem label="재직기간">
          <Grid container flexDirection="row" alignItems="center" width="fit-content">
            ...
            <Controller control={control} name="isWorking" rules={{ required: false }} render={({ field: { value, onChange } }) => <Checkbox checked={value} onChange={onChange} />} />
          </Grid>
          <Controller
            control={control}
            name="startDate"
        ...
        <FormItem label="설명">
          <Controller control={control} name="description" render={({ field }) => <TextField {...field} placeholder="회사에 대한 간단한 소개를 적어주세요." multiline fullWidth minRows={4} />} />
        </FormItem>
