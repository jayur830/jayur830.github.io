(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [890],
  {
    6734: function (e) {
                    ...
                    selections: [
                      ...
                      { kind: 'Field', name: { kind: 'Name', value: 'github' }, arguments: [], directives: [] },
                      {
                        ...
                        selectionSet: {
                          kind: 'SelectionSet',
                          selections: [
                            { kind: 'Field', name: { kind: 'Name', value: 'companyName' }, arguments: [], directives: [] },
                            {
                              kind: 'Field',
      ...
      n.definitions.forEach(function (e) {
        if (e.name) {
          var n = new Set();
          (function e(n, i) {
            if ('FragmentSpread' === n.kind) i.add(n.name.value);
            else if ('VariableDefinition' === n.kind) {
              var t = n.type;
              'NamedType' === t.kind && i.add(t.name.value);
            }
            n.selectionSet &&
              n.selectionSet.selections.forEach(function (n) {
                e(n, i);
              }),
              n.variableDefinitions &&
                n.variableDefinitions.forEach(function (n) {
                  e(n, i);
                }),
              n.definitions &&
        ...
        (e.exports = n),
        (e.exports.Resume = (function (e, n) {
          var a = { kind: e.kind, definitions: [t(e, n)] };
    ...
    4682: function (e, n, i) {
      Promise.resolve().then(i.bind(i, 7184));
    },
    7184: function (e, n, i) {
      'use strict';
      i.r(n),
      ...
      function g() {
        var e;
        let n = (0, d.Z)(),
          i = (0, s.Z)(n.breakpoints.down('sm')),
          { resumeData: a } = (function () {
            let { data: e, loading: n } = (0, v.a)(f()),
              i = (0, c.useMemo)(() => (n ? null : null == e ? void 0 : e.resume), [n, e]);
            return { resumeData: i };
          })();
        return (0, t.jsxs)(t.Fragment, {
          children: [
            (0, t.jsxs)(r.ZP, {
              ...
              gap: 2,
              children: [
                (0, t.jsx)(l.Z, { fontSize: i ? 26 : 36, fontWeight: 700, children: null == a ? void 0 : a.title }),
                (null == a ? void 0 : a.github) && (0, t.jsx)(o.Z, { href: null == a ? void 0 : a.github, target: '_blank', children: (0, t.jsx)(h, {}) }),
              ],
            }),
            (0, t.jsx)(r.ZP, {
              display: 'flex',
              ...
              paddingTop: 2,
              paddingBottom: 20,
              children: (null !== (e = null == a ? void 0 : a.history) && void 0 !== e ? e : []).map((e, n) => (0, t.jsx)(u.Nx, { data: e }, n)),
            }),
          ],
        });
      }
      let h = (0, m.ZP)(a.Z)((e) => {
        let { theme: n } = e;
        return { width: 40, height: 40, fill: 'dark' === n.palette.mode ? 'white' : 'black', [n.breakpoints.down('sm')]: { width: 25, height: 25 } };
      });
    },
  },
  function (e) {
    e.O(0, [774, 672, 651, 856, 294, 748, 744], function () {
      return e((e.s = 4682));
    }),
      (_N_E = e.O());
  },
