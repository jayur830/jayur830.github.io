"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[617],{1455:function(e,t,r){r.d(t,{C:function(){return signOut},E:function(){return deleteUser},X:function(){return GoogleAuthProvider},Y:function(){return GithubAuthProvider},c:function(){return signInWithPopup},d:function(){return linkWithPopup},o:function(){return getAuth},y:function(){return onAuthStateChanged}});var i,n=r(46962),s=r(64372),a=r(69134),o=r(26211),l=r(92254);function _prodErrorMap(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}let c=new n.LL("auth","Firebase",_prodErrorMap()),u=new a.Yd("@firebase/auth");function _logError(e,...t){u.logLevel<=a.in.ERROR&&u.error(`Auth (${s.Jn}): ${e}`,...t)}/**
 * @license
